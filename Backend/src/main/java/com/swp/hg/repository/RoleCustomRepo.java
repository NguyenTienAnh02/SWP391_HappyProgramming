...
public class RoleCustomRepo {
    ...
    public List<Role> getRole(User user) {
        StringBuilder sql = new StringBuilder("SELECT r.id as id, r.name as name FROM user u " +
        ...
        // Map the result to the Role class
        query.addScalar("id", StandardBasicTypes.INTEGER); // Ensure you retrieve the role ID
