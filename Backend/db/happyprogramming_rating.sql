...
CREATE TABLE `rating` (
  ...
  KEY `FKcwjjxpcsjrp6vpgw5hi7x5tbg` (`menteeid`) USING BTREE,
  KEY `FKan2sh3n3lag675mnhhukxfyr9` (`mentorid`) USING BTREE,
  CONSTRAINT `FKan2sh3n3lag675mnhhukxfyr9` FOREIGN KEY (`mentorid`) REFERENCES `mentor_profile` (`mentorid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKcwjjxpcsjrp6vpgw5hi7x5tbg` FOREIGN KEY (`menteeid`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
